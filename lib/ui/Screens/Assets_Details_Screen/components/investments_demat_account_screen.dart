          ...
          child: Column(
            ...
            children: [
              ...
              header(context,
                  image: investments,
                  title: "Investments",
                  description: "Demat Account"),
              Gap(16),
              Padding(
                  padding: EdgeInsets.only(left: 15),
                  child: Text(
                    pleaseShareTheDetailsDemat,
                    style: TextStyle(
              ...
              Gap(10),
              expandRow(context,
                  controller: dematAccNoController, title: "Demat Account No."),
              expandRow(context,
                  controller: dpNameController, title: "DP Name"),
              expandRow(context,
                  controller: nameJointHolderController,
                  title: "Joint Account Holder's Name (if any)"),
              expandRow(context,
