        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              expandRow(context,controller: boxController,title: "Universal Acc. No."),
              expandRow(context,controller: boxController,title: "EPF Acc. No."),
              expandRow(context,controller: boxController,title: "Name of the company/ Employee"),
              ...
              Center(
                child: CustomButton(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (context) => GovernmentNPS()));
                  },
                ),
              ),
              SizedBox(
