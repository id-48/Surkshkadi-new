...
class ResKycChatBot {
  ...
  int status;
  String message;
  ResponseSCB response;

  factory ResKycChatBot.fromJson(Map<String, dynamic> json) => ResKycChatBot(
    status: json["status"],
    message: json["message"],
    response: ResponseSCB.fromJson(json["response"]),
  );
...
class ResponseSCB {
  ...
  factory ResponseSCB.fromJson(Map<String, dynamic> json) => ResponseSCB(
    subRegisterStatus: json["sub_register_status"],
    motherName: json["mother_name"],
    isMotherAlive: json["is_mother_alive"],
    maritalStatus: json["marital_status"],
    spouseName: json["spouse_name"],
    divorceStatus: json["divorce_status"],
    noOfChildren: json["no_of_children"],
